...
import com.example.fahim.ibuyandsell.ViewHolder.ProductViewHolder;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        pAID=getIntent().getStringExtra("pUID");
...
//                                        Intent intent = new Intent(HomeActivity.this, AdminUpdateProductsActivity.class);
...
//                                        startActivity(intent);
                                        ...
                                        intent.putExtra("pid", model.getPid());
										pID =model.getUserid();
										intent.putExtra("p_userid",model.getUserid());
                                        startActivity(intent);
                                    }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        {
            Toast.makeText(this, "Click on the Product from list then Update", Toast.LENGTH_LONG).show();
