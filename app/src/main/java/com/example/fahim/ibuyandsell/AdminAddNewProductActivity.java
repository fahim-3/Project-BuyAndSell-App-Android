...
public class AdminAddNewProductActivity extends AppCompatActivity
{
    ...
    private  String productRandomKey,add_by, downloadImageUrl;
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toast.makeText(AdminAddNewProductActivity.this, "Product image has been uploaded", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "Got the product url", Toast.LENGTH_SHORT).show();
    ...
    private void saveProductInfoToDatabase()
    {
        ...
        String user_email=session.getUserEmail();
        productMap.put("pid", productRandomKey);
        productMap.put("userid",user_email);
